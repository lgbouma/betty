...
plt.legend(loc=0)
plt.savefig(join(TESTRESULTSDIR, 'test_fit_line_data.png'))
plt.close('all')
...
plt.tight_layout()
plt.savefig(join(TESTRESULTSDIR, 'test_fit_line_traceplot.png'))
plt.close('all')
...
plt.xlabel('x')
plt.ylabel('y')
plt.savefig(join(TESTRESULTSDIR, 'test_fit_line_posterior_samples.png'))
plt.close('all')
...
fig.savefig(join(TESTRESULTSDIR, 'test_fit_line_corner.png'))
